...
[Basket.js](http://addyosmani.github.io/basket.js/) provides an easy to use, Promise-based API, for caching both static and dynamicly loaded scripts. Basket.js can be used to load JavaScript, CSS, and even RequireJS modules.
